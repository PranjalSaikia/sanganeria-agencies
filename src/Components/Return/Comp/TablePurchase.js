        ...
        if (data.length > 0) {
            i = data.map((el, index) =>
                <tr key={index}>
                    ...
                    <td align="center"><Link to={`/stock/printr/${el.id}`} ><i className="fa fa-file"></i></Link></td>
                    <td align="center"><Link to={`/stock/editr/${el.id}`} ><i className="fa fa-pencil"></i></Link></td>
