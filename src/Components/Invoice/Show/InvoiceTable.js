        ...
        if (this.props.isLoading === false) {
            ...
            i = data.map((el, index) =>
                <tr key={index}>
                    ...
                    <td><Link to={`/printinvoice/${this.props.type}/${el.inv_no}`}><i className="fa fa-print"></i></Link></td>
                    <td><Link to={`/invoice/edit/${this.props.type}/${el.inv_no}`}><i className="fa fa-pencil"></i></Link></td>
